...
public class StartPage extends ShellPage {
    ...
    private static SelenideElement NAVIGATION_BUTTON = $("coral-tab[icon='compass']");
    private static SelenideElement TOOLS_BUTTON = $("coral-tab[icon='hammer']");
    ...
    public StartPage clickNavigationButton() { return clickButton(NAVIGATION_BUTTON); }
    public StartPage clickToolsButton() { return clickButton(TOOLS_BUTTON); }
    ...
    public enum ToolItemCard {
        ...
        public ToolsGroup getGroup() { return group; }
