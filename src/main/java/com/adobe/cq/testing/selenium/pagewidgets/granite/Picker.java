...
public final class Picker extends Dialog {
    ...
    private static final AutoCompleteField FULL_TEXT_SEARCH = new AutoCompleteField("fulltext");
     ...
     */
    public Picker() {
        super("coral-dialog.foundation-picker-collection.is-open");
        init();
    }
    ...
    private void switchToView(final ViewType viewType, final Collection viewCollection) {
        ...
        if (viewChanged) {
            Helpers.waitNetworkIdled(NETWORK_IDLE_INTERVAL);
