...
public abstract class EditorPage extends BasePage {
    ...
    private DeviceEmulatorBar deviceEmulatorBar;
    private ContexthubUI contexthubUI;
    ...
    public DeviceEmulatorBar getDeviceEmulatorBar() { return (deviceEmulatorBar == null) ? deviceEmulatorBar = new DeviceEmulatorBar() : deviceEmulatorBar; }
    public ContexthubUI getContexthubUI() { return (contexthubUI == null) ? contexthubUI = new ContexthubUI() : contexthubUI; }
