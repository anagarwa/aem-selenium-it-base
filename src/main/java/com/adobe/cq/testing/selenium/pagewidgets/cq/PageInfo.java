...
import com.adobe.cq.testing.selenium.pageobject.cq.sites.PublishPageWizard;
...
public final class PageInfo extends BaseComponent {
    ...
    private StartWorkflowDialog startWorkflowDialog = new StartWorkflowDialog();
    private PublishPageWizard publishPageWizard = new PublishPageWizard();
    ...
    public StartWorkflowDialog clickStartWorkflowButton() { return clickDialogAction(getStartWorkflowButton(), startWorkflowDialog); }
    public Dialog clickUnpublishPageButton() { return clickDialogAction(getUnpublishPageButton(),unpublishPageDialog); }

    public PublishPageWizard clickPublishPageButton() {
        ExpectNav.on(() -> clickableClick(buttonPublishPage));
        publishPageWizard.waitReady();
        return publishPageWizard;
    }
