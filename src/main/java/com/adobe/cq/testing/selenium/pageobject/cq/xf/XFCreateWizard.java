...
public class XFCreateWizard extends Wizard {

  private static final String CREATE_WIZARD_URL = "/mnt/overlay/cq/experience-fragments/content/v2/experience-fragments/createxfwizard.html";
  ...
  private static final String PANEL_IS_SELECTED_TEXT = "coral-panel.is-selected textarea";
  ...
  private static final SelenideElement DESCRIPTION_FIELD = DESCRIPTION.getFullyDecoratedElement(PANEL_IS_SELECTED_TEXT);
