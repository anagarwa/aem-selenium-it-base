...
public final class Omnisearch extends BaseComponent {
    ...
    public void toggleFilter() {
        final String selector = "#granite-omnisearch-result-rail-toggle button[title='Content Only']";
        final String  railPanelSelector = "coral-overlay[open] div[id='granite-omnisearch-result-rail']";
        $(selector).should(Constants.EXISTS_ENABLED_VISIBLE).click();
        Helpers.waitForElementAnimationFinished(railPanelSelector);
    }
    ...
    public void openFromFilter() {
        final String i18nFilter = I18N.geti18nString("Filter");
