...
public class RestoreVersionWizard extends Wizard {
  ...
  private static final SelenideElement COLLECTION_STATUS = new BaseComponent(".cq-common-collectionstatus").element();
  ...
  public static RestoreVersionWizard open(final String parent, final String source) {
    return new RestoreVersionWizard().open(String.format("%s%s?%s", RESTORE_VERSION_WIZARD_URL, parent, source));
  }
